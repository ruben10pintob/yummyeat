...
(49, 'HOLLYWOOD COMBO', 'Fingers de queso, aros de cebolla, delicias de jalapeños y Foster\'s Chicken Pops (muslitos de alita de pollo), con salsa ranchera y barbacoa, para dip', 'Entrante', '9.95'),
...
(63, 'FOSTER\'S CAESAR SALAD', '\r\nPechuga de pollo a la parrilla, lechuga romana, croutons, queso grana padano, aliñado con salsa parmesana.', 'Principal', '11.90'),
(64, 'MEDITERRANEAN SALAD', '\r\nPaleta ibérica en tiras, queso de cabra, tomates cherry y pasas sobre mezcla de lechugas. Alíñala con la salsa que más te guste, mostaza y miel, aceite y vinagre o nuestra vinagreta dulce Vin Brulé con matices de vino.', 'Principal', '11.90'),
(65, 'SANTA MÓNICA', '\r\nPollo empanado en trozos, bacon crujiente, mezcla de quesos rallados y tomate sobre una mezcla de lechugas. Elige tu salsa entre susa, queso azul, mostaza y miel o aceite y vinagre.', 'Principal', '11.90'),
(66, ' THE NEWYORKER 325 GRS', '\r\nJugoso entrecotte sazonado y preparado en nuestra parrilla. Servido con nuestra deliciosa salsa Steakhouse.', 'Principal', '14.90'),
(67, 'FLANK STEAK 300 GRS', '\r\nCorte argentino, vacío de vacuno marinado en cerveza negra. Preparado a la parrilla con carbón vegetal y acompañado con salsa Steakhouse.', 'Principal', '14.90'),
(68, 'SALISBURY STEAKS', '\r\nSabrosa carne de vacuno aderezada, servida con salsa de champiñones, cebolla pochada y mezcla de quesos fundidos. No te pierdas nuestro delicioso Salisbury Steak acompañado de ensalada de lechuga, tomate y jalapeños.', 'Principal', '14.90'),
...
(71, 'CAVATAPPI CHICKEN PASTA', '\r\nPasta con crema elaborada con nata, mezcla de queso, cebolla caramelizada y salsa Búfalo picante. Te servimos nuestro Cavatappi Chicken Pasta con pechuga de pollo al estilo cajún o la parrilla y tostadas de pan.', 'Principal', '12.90'),
...
(73, 'CHICKEN & RICE WOK', '\r\nPops de pollo rebozados y especiados, caramelizados con salsa Teriyaki, pimiento rojo y verde, cebolla pochada y arroz Basmati. Coronado con semillas de sésamo y cilantro. ', 'Principal', '11.90'),
(74, 'CAESAR SANDWICH', '\r\nPechuga de pollo a la parrilla, bacon crujiente, lechuga romana y salsa parmesana en pan con semillas y copos de avena.', 'Principal', '10.90'),
...
(79, 'ORLEANS BURGER', '\r\nPollo rebozado al estilo sureño sobre base de guacamole y coronado con chili con carne, servido en pan de cristal, acompañada de patatas Dipper. Y antes de que disfrutes del primer mordisco, la culminamos en tu mesa rallando queso Cheddar madurado.', 'Principal', '13.90'),
...
(82, ' FOSTER\'S CAESAR BURGER', 'Carne de vacuno con queso grana padano, bourbon style bacon, lechuga romana, tomate, salsa parmesana y pan rústico de semillas.', 'Principal', '12.90'),
...
(87, 'THE VEGGIE BURGER', '\r\nBurger de arroz integral, quinoa, beans, salsa BBQ, lechuga trocadero, tomate, aguacate, cebolla morada, maíz, mayonesa garden y queso monterrey jack. En pan rústico de semillas. ', 'Principal', '11.90'),
(88, 'BBQ EGG BURGER', '\r\n¡Con huevo a la plancha! Cebolla pochada, bacon ahumado con madera de haya, lechuga batavia, tomate, salsa barbacoa y, por supuesto, carne de vacuno en pan clásico.', 'Principal', '11.90'),
(89, 'DIRECTOR’S CHOICE', '\r\nDirector’s Choice, tu Burger de siempre, ahora con los ingredientes que prefieras. Pide nuestra receta recomendada Foster’s Hollywod: Carne de vacuno con queso Cheddar, bacon ahumado con madera de haya, cebolla morada a la plancha, tomate, lechuga Batavia, pan clásico y mayonesa. Además, ¡personal', 'Principal', '10.90'),
...
(93, 'ALL STAR BROWNIE', '\r\nBrownie caliente de chocolate, acompañado de helado de vainilla, cubierto con nueces y nuestra salsa de chocolate caliente.', 'Postre', '7.95'),
(94, 'CHEESE & CHOCOLATE CAKE', '\r\nTarta de queso con una base de bizcocho de chocolate, servida con nata y chocolate caliente.', 'Postre', '6.95'),
...
(98, ' DEATH BY CHOCOLATE', '\r\nBase de bizcocho de chocolate, con helado de chocolate cubierto con una crujiente capa de chocolate blanco\r\ny salsa de chocolate, pepitas de chocolate puro, chispas de azúcar oro y un toque de leche condensada.', 'Postre', '7.95'),
(99, 'DEVIL\'S FOOD CAKE', 'Delicioso bizcocho de chocolate relleno de crema de chocolate, cubierto con chocolate fondant y bañado con nuestra salsa de chocolate y trocitos de galleta Chips Ahoy®.', 'Postre', '7.95'),
...
(102, 'COPA DE HELADO BEN & JERRY\'S', 'Dos bolas de delicioso helado: chocolate fudge Brownie, strwberry cheesecake o vainilla cookie dough.', 'Postre', '5.95'),
